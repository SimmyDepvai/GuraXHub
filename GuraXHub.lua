...
local Window = OrionLib:MakeWindow({Name = "GuraXHub by Quốc Huy", HidePremium = false, IntroText = "Scipts của bạn Đây:)))", SaveConfig = true, ConfigFolder = "GuraXHub Hub"})
----------Tab-----------------------
...
spawn(function()
    while wait() do
        pcall(function()
            if _G.V3 then
                game:GetService("VirtualInputManager"):SendLKeyEvent(true,"T",false,game)
                wait(0.1)
